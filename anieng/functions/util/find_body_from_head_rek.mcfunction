...
execute unless score #tuuid0 ani_ram = #auuid0 ani_ram run tag @s remove ani_sel_body
execute unless score #tuuid1 ani_ram = #auuid1 ani_ram run tag @s remove ani_sel_body
execute unless score #tuuid2 ani_ram = #auuid2 ani_ram run tag @s remove ani_sel_body
execute unless score #tuuid3 ani_ram = #auuid3 ani_ram run tag @s remove ani_sel_body
