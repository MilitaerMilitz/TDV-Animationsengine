...
execute unless entity @e[tag=ani_sel_body] as @e[tag=ani_body,type=armor_stand,sort=nearest,distance=..3] at @s run function anieng:util/find_body_from_act_rek
...
execute unless entity @e[tag=ani_sel_head] as @e[tag=ani_head,type=armor_stand,sort=nearest,distance=..3] at @s run function anieng:util/find_head_from_act_rek
