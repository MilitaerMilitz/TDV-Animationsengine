...
scoreboard players operation @s ani_rot = @s ani_rot_s

scoreboard players operation @s ani_head_x = @s ani_head_x_s
scoreboard players operation @s ani_head_y = @s ani_head_y_s
scoreboard players operation @s ani_head_z = @s ani_head_z_s

scoreboard players operation @s ani_body_x = @s ani_body_x_s
scoreboard players operation @s ani_body_y = @s ani_body_y_s
scoreboard players operation @s ani_body_z = @s ani_body_z_s

scoreboard players operation @s ani_left_arm_x = @s ani_left_arm_x_s
