...
data modify storage ani_out data.id set value 5
execute store result storage ani_out data.wspeed short 1 run scoreboard players get @s ani_walk_speed
execute store result storage ani_out data.tbw byte 1 run scoreboard players get @s ani_tbw
execute store result storage ani_out data.narm byte 1 run scoreboard players get @s ani_narm
