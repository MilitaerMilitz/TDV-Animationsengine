...
execute if score #numbertolen ani_ram matches 0..9 at @s run data modify block ~ -64 ~ Text1 set value '[{"text":"0"},{"nbt":"ID","storage":"ani_vintest","interpret":true}]'
execute if score #numbertolen ani_ram matches 10.. at @s run data modify block ~ -64 ~ Text1 set value '[{"nbt":"ID","storage":"ani_vintest","interpret":true}]'
