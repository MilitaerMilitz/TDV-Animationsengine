...
execute store success score #saved ani_ram unless score @e[tag=ani_sel_as,limit=1] ani_action matches 310 unless score @e[tag=ani_sel_as,limit=1] ani_action matches 320 unless score @e[tag=ani_sel_as,limit=1] ani_action matches 330 unless score @e[tag=ani_sel_as,limit=1] ani_action matches 340
